...
return (
    <div>
        <header className="border-b shadow-2xl bg-slate-100 dark:bg-indigo-950 dark:border-none md:p-1">
          <nav className="flex items-center justify-center md:justify-between sm:justify-between 
          md:gap-28 text-center gap-28 py-2 px-20 md:py-3.5 px-28">
