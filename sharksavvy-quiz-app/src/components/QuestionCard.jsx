  ...
  return (
    <>
        ...
        <div className="flex flex-row justify-center mt-12 p-40 gap-24 ">
            ...
            <h1 className="text-blue-700 text-2xl font-bold">What was the first Disney animated <br />feature movie that was not based <br />on an already existing story?</h1>
            </div>
            <div className="flex flex-col gap-7">
