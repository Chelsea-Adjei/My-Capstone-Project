  ...
  return (
    <>
        ...
        <div className="flex flex-col sm:flex-col md:flex-col justify-center  mt-12 p-40 gap-24">
          ...
          <h1 className="text-blue-700 text-md font-bold md:text-3xl">What was the first Disney animated <br />feature movie that was not based <br />on an already existing story?</h1>
          </div>
          <div className="flex flex-col gap-7 ">
           <ul className="flex flex-col gap-6">
             <li className="flex items-center h-10 p-4 border border-blue-300 rounded-md bg-white text-l font cursor-pointer">A. Snow White</li>
